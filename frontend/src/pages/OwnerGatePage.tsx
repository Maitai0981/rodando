  ...
  return (
    <div className="min-h-screen grid place-items-center px-4 bg-[#0a0a0f]">
      <div className="p-6 rounded-2xl w-full max-w-lg bg-white/[0.03] border border-white/[0.06]">
        <p className="text-xs uppercase tracking-widest text-[#d4a843] font-semibold">Área restrita</p>
        <h1 className="text-2xl mt-2 text-[#f0ede8] font-bold">Painel de Gestão Rodando</h1>
        <p className="text-sm mt-2 text-[#6b7280]">Acesso exclusivo para colaboradores da Rodando Moto Center.</p>
